...
<nav id="nav_bar_circle" class="navbar navbar-expand-sm container py-0 mt-3" style="display: block; height: 100px;">
	...
	<ul class="navbar-nav justify-content-center col-md-12" width="100">
    	<li class="nav-item">
	      	<div class="mx-auto">
	      		<a href="<%= ctxPath%>/shop/cartList.moc" data-transition="fade">
	      		  <span id="navbar_page" class="rounded-circle"></span>
	      		</a>
	      	</div>
		</li>
		...
		<li class="nav-item">
	      	<div class="mx-auto">
	      		<a type="button" id="btnOrder" data-transition="fade">
	      		  <span id="navbar_page" class="rounded-circle"></span>
	      		</a>
	      	</div>
		</li>
		...
		<li class="nav-item">
	      	<div class="mx-auto">
		      	<a  type="button" id="btnPay" data-transition="fade">
		      	  <span id="navbar_page" class="rounded-circle" style="background-color: white;"></span>
		      	</a>
	      	</div>
		</li>
	</ul>
