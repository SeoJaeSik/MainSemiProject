...
<script type="text/javascript">
	...
	alert("${requestScope.message}"); // 메시지 출력해주기 // request 영역에 저장해둔 key값 message 로 가라
	
	location.href="${requestScope.loc}"; // 페이지 이동 // request 영역에 저장해둔 key값 message 로 가라
