			...
			<div class="세로">
				<section>
					<div class="row col-md-10 mx-auto my-5 justify-content-end">
						<div class="col-3"> </div>
						<div class="col-6"><h2 style="font-weight: bold;">YOUR ACCOUNT</h2></div>
						<div class="col-3 text-center"><button class="a2 btn btn-warning btn-md" id="btnPay" onclick="goLogOut();">LOG OUT</button></div>
		  			</div>
					...
					<ul class="nav nav-pills justify-content-around" style="margin-bottom: 80px;">
					  	<li class="nav-item">
					    	<a class="nav-link active" data-toggle="pill" href="#">개인정보수정</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" data-toggle="pill" href="#">장바구니</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" data-toggle="pill" href="#">주문내역</a>
					  	</li>
					  	<li class="nav-item">
					    	<a class="nav-link" data-toggle="pill" href="#">고객센터</a>
					  	</li>
					</ul>
					...
					<div class="tab-content py-3" style="background-color:#fefce7;" >
					  	...
					  	<div class="tab-pane container fade" id="cart">
					    	<h5 class="my-3">orderList</h5>
							Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
					  	</div>
					  	<div class="tab-pane container fade" id="orderList">
					    	<h5 class="my-3">주문내역 및 배송현황</h5>
