...
<div id="body">
	...
	<div class="main_video" style="margin-bottom: 100px;"> 
		...
		<div class="btn_wrap btn_wrap-main py-5 text-center">
			...
			<button class="btn btn-dark btn-lg" style="margin-left:10px; background-color: black !important; width: 140px; height:50px; font-weight: bold; font-size: 11pt !important;">구매하기</button>
		</div>
	</div>
...
<jsp:include page="footer.jsp"/>
>>>>>>> branch 'main' of https://github.com/5yunhwan/MainSemiProject.git
